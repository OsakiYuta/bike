...
export default function Home() {
  ...
  return <>
    <main>
      <section className="intro" id="lab"><div><div className="eyebrow"><span/> 实验室 01 / DRIVETRAIN</div><h1>同样的踏频，<span>能骑多快？</span></h1><p>换个牙盘、拨一下飞轮，看看你的每一次踩踏，能带你走多远。</p></div><a className="intro-link" href="#principles">第一次接触齿比？<br/><span>往下看看原理 <ArrowDown size={15}/></span></a></section>
